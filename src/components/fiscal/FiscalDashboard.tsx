    ...
    <div className="space-y-6 mt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="border-border transition-spring hover:scale-105 hover:shadow-elegant">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-primary">{Math.round(stats.progressMes)}%</div>
            <Progress value={stats.progressMes} className="mt-2 h-2" />
            <p className="text-xs text-muted-foreground mt-1">
              {stats.eventosVencidos} já vencidos
            </p>
          </CardContent>
        </Card>
      </div>
